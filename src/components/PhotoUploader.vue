  ...
  <div class="photo-uploader">
    ...
    <div v-if="imagePreviews.length > 0" class="previews-grid">
      <div 
        ...
        class="preview-item"
      >
        <img :src="preview" :alt="$t('uploader.previewAlt')" @click="openModal(preview)" />
...
// НАЛАШТУВАННЯ РОЗМІРУ (наприклад, 10 МБ)
