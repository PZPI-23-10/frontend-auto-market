...
const API_LOGIN_URL = 'https://jellyfish-app-obre9.ondigitalocean.app/api/Auth/login';
const API_GOOGLE_LOGIN_URL = 'https://jellyfish-app-obre9.ondigitalocean.app/api/Auth/web/google';
